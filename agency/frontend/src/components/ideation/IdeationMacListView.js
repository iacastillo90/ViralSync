                ...
                >
                  ...
                  <td className="px-3 py-2 whitespace-nowrap">
                    <span
                      ...
                      className={`px-2 py-0.5 rounded border text-[10px] font-mono font-bold inline-flex items-center gap-1 cursor-pointer hover:border-indigo-400 transition-colors ${
                        isService
                  ...
                  {/* Duración */}
                  <td className="px-3 py-2 text-center font-mono text-[11px] text-slate-400 whitespace-nowrap">
                    ~{estimatedDuration}s
                  </td>
                  ...
                  <td className="px-4 py-2 text-right whitespace-nowrap">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      {isApproved ? (
                        <span className="bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 text-[10px] font-bold px-2 py-1 rounded-md ml-1">
                          ✓ Aprobada
                        </span>
                      ) : (
                        onApprove && (
