...
import { Search, Grid, List, Sparkles, Filter, ArrowUpDown } from "lucide-react";

/**
 * VideosHeaderBar
 * Barra de herramientas estilo macOS Finder para la vista de Aprobación y Gestión de Videos.
 * Proporciona controles de ventana macOS (🔴 🟡 🟢), barra de búsqueda, filtro por tipo de oferta, ordenamiento y selector de vista (Iconos vs Lista).
 */
export function VideosHeaderBar({
  searchQuery,
  setSearchQuery,
  viewMode,
  setViewMode,
  ...
  return (
    <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl backdrop-blur-md space-y-4">
      {/* Fila Superior: Controles de Ventana macOS + Título Módulo + Estadísticas */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold text-slate-100 flex items-center gap-2">
              ...
              <span>Gestión y Aprobación de Videos Virales</span>
            </h2>
            <p className="text-[11px] text-slate-400">
              Visualiza, audita y aprueba publicaciones de Reels formateadas en 9:16
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center gap-2 bg-indigo-950/80 border border-indigo-500/40 px-3 py-1.5 rounded-xl animate-fadeIn">
            ...
            {onBulkApprove && (
              <button
                ...
                className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-[11px] px-2.5 py-1 rounded-lg shadow transition-all"
              >
                Aprobar
              </button>
            )}
            ...
            {onBulkDownload && (
              <button
                ...
                className="bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-[11px] px-2.5 py-1 rounded-lg border border-slate-700 transition-all"
              >
                Descargar
              </button>
            )}
      ...
      {/* Fila Inferior: Buscador + Filtros por Tipo de Oferta + Selector de Ordenamiento + Toggle Grid/List */}
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="relative flex-1 min-w-[240px] max-w-md">
          ...
          <input
            ...
            placeholder="Buscar videos por producto, servicio o texto..."
        ...
        {/* Grupo de Filtros y Controladores */}
        <div className="flex items-center gap-2 flex-wrap">
          {/* Filtro por Categoría / Tipo de Oferta */}
          <div className="flex items-center gap-1.5 bg-slate-950/80 border border-slate-800 px-2.5 py-1.5 rounded-xl">
            ...
            >
              <option value="all" className="bg-slate-900 text-slate-200">✨ Todos los Tipos</option>
